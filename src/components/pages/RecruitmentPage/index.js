...
const RecruitmentPage = () => (
  ...
  >
    ...
    <div className="recruitment-page__main">
      ...
      <p className="recruitment-page__paragraph">To apply, first register and create an account on our forum. You can reach our forum by clicking on the menu bar, or by clicking on <a href="http://www.tempest-guild.co.uk/forum">this link</a>. Once you’re registered you'll have access to the "Application" section where stickies explain everything you need to do. Please note that all applications are private, no one other than yourself and the select players in our guild used for reviewing can see them.</p>
      <p className="recruitment-page__paragraph important">Important - before filling out the form: make sure you have your answers written in a separate document and copy paste them in! This way if an error happens you don't have to rewrite everything.</p>
    </div>
  </PageTemplate>
)
